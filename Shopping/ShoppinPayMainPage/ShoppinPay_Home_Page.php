...
<head>
  ...
  <link rel="stylesheet" href="../ShoppinPayCSS/ShoppinPay_Main_Page.css">
</head>
<body>
  ...
  <nav>
    ...
    <ul>
      ...
      <li><a href="ShoppinPay_About.php">About</a></li>
      <li>
        <!-- Floating Cart Icon -->
  ...
  <section class="hero">
    ...
    <p>Your one-stop shop with secure payments</p>
    <button onclick="window.location.href='ShoppinPay_Shop.php'">Start Shopping</button>
  </section>
...
<section class="exclusive-offer">
  <h7>🔥 EXCLUSIVE OFFER SALE 🔥</h7>
  <div class="exclusive-products"></div>
  <!-- Products Section -->
  ...
  <div class="product-image h1-img"
      ...
      <h1>Own the Game 3 Shoes White</h1>
  <p>2,900.00 PHP</p>
